...
package net.silkmc.silk.test.compose.game
...
@Composable
@Preview
fun FallingBallsGameComposable() {
    val game = remember { FallingBallsGame() }
    ...
    Column {
        ...
        if (game.started) {
            Box(modifier = Modifier
                ...
                game.pieces.forEachIndexed { index, piece -> FallingBallsPiece(index, piece) }
            }
        }
